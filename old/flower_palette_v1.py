...
app.layout = html.Div([
    ...
    dcc.Dropdown(
        ...
        options=[{"label": "Rose", "value": "roses"},
                 {"label": "Peony", "value": "peonies"},
                 {"label": "Tulip", "value": "tulips"},
                 {"label": "Sunflower", "value": "sunflowers"},
                 {"label": "Anthurium", "value": "anthuriums"}],
    ...
    return html.Div([
        ...
        html.Div([
            html.Div([
                ...
                html.P(c, style={"textAlign": "center", "fontSize": "12px"})
            ], style={
